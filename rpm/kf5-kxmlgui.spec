...
BuildRequires:  opt-kf5-kconfig-devel >= %{majmin}
BuildRequires:  opt-kf5-kconfigwidgets-devel >= %{majmin}
BuildRequires:  opt-kf5-kcoreaddons-devel >= %{majmin}
BuildRequires:  opt-kf5-kglobalaccel-devel >= %{majmin}
BuildRequires:  opt-kf5-kguiaddons-devel >= %{majmin}
BuildRequires:  opt-kf5-ki18n-devel >= %{majmin}
BuildRequires:  opt-kf5-kiconthemes-devel >= %{majmin}
BuildRequires:  opt-kf5-kitemviews-devel >= %{majmin}
BuildRequires:  opt-kf5-ktextwidgets-devel >= %{majmin}
BuildRequires:  opt-kf5-kwidgetsaddons-devel >= %{majmin}
BuildRequires:  opt-kf5-kwindowsystem-devel >= %{majmin}
...
%{_opt_kf5_libexecdir}/ksendbugmail
